                    ...
                    <div class="post-container">
                      <?php
                        ...
                        <div class="post-content">
                            <div class="row">
                                <div class="col-md-4">
                                    <a class="post-img" href="<?php echo $load ?>/single/<?php echo $row['post_id'] ?>">
                      ...
                      <ul class='pagination admin-pagination'>
                        <?php  if($page>1){?>
                      <li class=''><a href='<?php echo $load ?>/index/<?php echo $page-1 ?>'>Prev</a></li>;
                    <?php  }?>
                        <?php
                        for($i=1;$i<=$total_pages;$i++)
                        {
                          $active=($page==$i)?'active':'';
                          echo "<li class='{$active}' ><a href='{$load}/index/$i'>{$i}</a></li>";
                        }

                         ?>
    <?php if($page<$total_pages){ ?>
                         <li class=''><a href='<?php echo $load ?>/index/<?php echo $page+1 ?>'>Next</a></li>;
                       <?php } ?>
                      </ul>
                    <?php } ?>
                    </div><!-- /post-container -->
